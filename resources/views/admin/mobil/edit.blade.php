...
<main class="main" id="main">
    ...
    <section class="section">
        <div class="row">
            <div class="card">
                <h1 class="card-title">Edit Data Mobil</h1>
                @if($errors->any())
                ...
                <form action="{{ route('daftar_mobil.update', $daftarMobil->id) }}" method="POST"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" name="tgl_masuk" id="tgl_masuk"
                                value="{{ old('merk', $daftarMobil->tgl_masuk) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="plat_nomer" id="plat_nomer"
                                value="{{ old('merk', $daftarMobil->plat_nomer) }}" required>
                        </div>
                    </div>
